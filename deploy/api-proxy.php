<?php
/**
 * Forwards /api/* from public_html to the Node backend on localhost (Passenger PORT).
 * Same-origin API avoids browser blocking a separate self-signed api subdomain cert.
 */
declare(strict_types=1);

$backendBase = 'https://api.iranfoodd.ir';
