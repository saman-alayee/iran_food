export const defaultSiteContent = {
  ...
  images: {
    logo: '/images/iran-food-logo.png',
    countdownHero: '/images/coming-soon-hero.png',
    whyHero: '/images/why-section-hero.png',
  },
  buttons: {
    participate: { label: 'مشارکت در پروژه', href: '#rewards', enabled: true },
    uploadHero: { label: 'آپلود عکس غذا', enabled: true },
    uploadNav: { label: 'آپلود عکس', enabled: true },
    uploadFooter: { label: 'آپلود عکس غذا', enabled: true },
  },
  social: {
